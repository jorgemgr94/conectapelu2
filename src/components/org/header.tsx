      ...
      <div className="flex flex-1 items-center gap-4">
        <div className="group relative w-full max-w-md">
          <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
            <Search className="h-4 w-4 text-neutral-400 transition-colors group-focus-within:text-tertiary-highlight" />
          </div>
          <input
            type="search"
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
            <kbd className="hidden items-center gap-1 rounded-lg border border-neutral-200 bg-white px-2 py-1 text-xs font-medium text-neutral-400 sm:flex">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="absolute right-2.5 top-2.5 flex h-2 w-2">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-tertiary-highlight opacity-75" />
            <span className="relative inline-flex h-2 w-2 rounded-full bg-tertiary-highlight-dark" />
          </span>
        </Button>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-tertiary text-sm font-bold text-white shadow-tertiary">
              {initials}
            </div>
