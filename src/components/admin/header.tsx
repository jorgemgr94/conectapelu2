      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl bg-gradient-brand text-sm font-bold text-white shadow-brand">
              {user.avatar ? (
                <Image
                  src={user.avatar}
                  alt={displayName}
